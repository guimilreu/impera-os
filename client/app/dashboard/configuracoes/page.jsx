					...
					<div className="space-y-2">
						<div className="flex items-center space-x-2">
							<Checkbox
								...
								onCheckedChange={(checked) => setFormData({ ...formData, premiacaoEncerrada: checked })}
							/>
					...
					<div className="space-y-2">
						<div className="flex items-center space-x-2">
							<Checkbox
								...
								onCheckedChange={(checked) => setFormData({ ...formData, notificacoes: checked })}
							/>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					...
					<Link href="/dashboard/edicoes">
						<Button variant="outline" className="mt-2 w-full justify-between group">
							<div className="flex items-center gap-2">
